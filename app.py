...
def terms(): return page(f"""<div class=box><h2 style=text-align:center>⚖️ الشروط القانونية والأحكام</h2><div style=line-height:2.3;font-size:14px;text-align:right>
    <b>1- طبيعة المنصة:</b> منصة وسيط تعارف فقط بإشراف وضمان الأستاذ {ADMIN_NAME}، تربط بين فاقد الشيء وواجده لوجه الله، ولا تتدخل في عملية التسليم بشكل مباشر إلا للوساطة.<br><br>
    <b>2- عدم استلام المفقودات:</b> الإدارة لا تستلم أي مفقودات نهائيا ولا تحتفظ بها، الحاجة تظل أمانة في يد من وجدها حتى يصل لصاحبها.<br><br>
    <b>3- آلية التسليم:</b> الأصل أن يتم التسليم مباشرة بين الطرفين بعد التأكد من المواصفات الدقيقة. واذا كانت الأمانة ثمينة ورغب الطرفان في ضمان إضافي، يمكن كخيار مفتوح أن يتم التسليم برعاية مكتب محاماة وتحرير إقرار استلام قانوني يحفظ حق الطرفين، وذلك بالاتفاق بينهما وليس إلزاما من المنصة.<br><br>
    <b>4- المسؤولية:</b> الإدارة غير مسؤولة عن صحة بيانات المعلنين، والتعامل يتم بحسن نية وعلى مسؤولية الأطراف، والمنصة غير مسؤولة عن أي تعاملات مالية بينهم.<br><br>
    <b>5- الأمانة:</b> من وجد شيئا وجب عليه تعريفه ورده لأهله، ومن كتمه فقد أثم. المنصة تذكركم بقول الله تعالى وقول رسوله الكريم حسبة لله.<br><br>
    <center><b style=color:#0d5a3c>قال تعالى: "إِنَّ اللَّهَ يَأْمُرُكُمْ أَن تُؤَدُّوا الْأَمَانَاتِ إِلَىٰ أَهْلِهَا"<br>وقال رسول الله ﷺ: "من كتم ضالة فهو ضال"</b></center>
