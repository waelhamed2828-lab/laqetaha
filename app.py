...
.btn{{display:block;padding:16px;text-align:center;border-radius:14px;color:white;text-decoration:none;font-size:17px;font-weight:bold;margin:10px 0}}
    ...
    <div style=max-width:550px;margin:auto;padding-bottom:100px>{content}</div>
    <script>if('serviceWorker' in navigator){{ navigator.serviceWorker.register('/sw.js') }}</script>
    </body></html>"""

@app.route("/manifest.json")
def manifest():
    return jsonify({"name": f"لقيتها - {ADMIN_NAME}", "short_name":"لقيتها","start_url":"/","display":"standalone","background_color":"#ffffff","theme_color":"#0d5a3c","icons":[{"src":"/icon.png","sizes":"512x512","type":"image/png"}]})
...
def home():
    ...
    <p style=margin:0;font-size:14px;line-height:2>التطبيق ده معمول لوجه الله ولأولاد الحلال فقط<br>اللي بيلاقي حاجة في الشارع ونفسه يرجعها لصاحبها ومش عارف يوصله،<br>واللي ضايع منه حاجة وقلبه محروق عليها.</p>
    <hr style=border-color:#ffffff30;margin:15px 0>
    <p style=margin:0;font-size:14px;line-height:1.9>قال تعالى:<br><b style=font-size:16px;color:#ffecb3>"إِنَّ اللَّهَ يَأْمُرُكُمْ أَن تُؤَدُّوا الْأَمَانَاتِ إِلَىٰ أَهْلِهَا"</b><br><small>[النساء: 58]</small><br><br>وقال رسول الله ﷺ:<br><b style=color:#ffecb3>"من آوى ضالة فهو ضال ما لم يُعرِّفها"</b><br><small>رواه مسلم</small><br><br>وقال ﷺ: <b style=color:#ffecb3>"والله في عون العبد ما كان العبد في عون أخيه"</b></p>
    </div>
    <p style=font-size:12px;opacity:.8;margin:0>بإشراف وضمان: {ADMIN_NAME} - {ADMIN_PHONE}<br>اللهم اجعل هذا العمل خالصا لوجهك 🤲</p>
    </div>
    <div class="box alert"><b>⚖️ نظام الأمانة عندنا:</b><br>1- اللي بيلاقي يقول "لقيت كذا في محافظة كذا" فقط، بدون أي تفاصيل دقيقة.<br>2- الحاجة بتفضل معه هو في بيته، <b>مش بتتسلم للإدارة.</b><br>3- صاحب الحاجة هو اللي يتواصل مع الوسيط ويثبت بمواصفات دقيقة ومكان الوقوع.<br>4- التسليم النهائي يتم بشكل قانوني برعاية مكتب محاماة لضمان حق الطرفين.</div>
    ...
    <a href=/pay class=btn style="background:linear-gradient(135deg,#ff8f00,#ff3d00);color:#000;font-size:18px">⭐ ثبت مفقوداتك ب 20 ج 💰</a>
    <div style=height:80px></div>
<button id="installBtn" style="position:fixed;bottom:15px;left:50%;transform:translateX(-50%);width:90%;max-width:520px;background:#0d5a3c;color:#fff;padding:18px 10px;border-radius:18px;border:2px solid #fff;font-weight:800;font-size:19px;z-index:999999;box-shadow:0 8px 25px #0005">📲 ثبت التطبيق</button>
<script>
...
@app.route("/terms")
def terms():
    return page(f"""<div class=box><h2 style=text-align:center>⚖️ الشروط القانونية واخلاء المسؤولية</h2><div style=line-height:2.2;font-size:14px><b>1- طبيعة التطبيق:</b> منصة وسيط تعارف فقط، بإشراف وضمان الأستاذ {ADMIN_NAME}.<br><br><b>2- عدم الاستلام:</b> الإدارة <b>لا تستلم أي مفقودات بيدها نهائيا</b>.<br><br><b>3- نظام التحقق:</b> صاحب الشيء هو المطالب بإثبات المواصفات الدقيقة.<br><br><b>4- التسليم القانوني:</b> <b>يتم بشكل قانوني برعاية مكتب محاماة معتمد</b> مع توقيع إقرار استلام.<br><br><b>5- اخلاء المسؤولية:</b> الإدارة غير مسؤولة عن صحة بيانات المعلنين.<br><br><b>6- التقدير:</b> أي إكرامية تطوعية بين الطرفين ولا تتدخل فيها الإدارة.</div><a href=/ class=btn style=background:#0d5a3c>موافق والعودة للرئيسية ✅</a><p style=text-align:center;font-size:12px>للتواصل القانوني: {ADMIN_NAME} - {ADMIN_PHONE}</p></div>""")
...
@app.route("/pay")
def pay_page():
    return page(f"""<div class=box style=text-align:center><h2>⭐ تثبيت إعلانك أول الصفحة</h2><div class=alert style=text-align:right>عايز إعلانك يفضل فوق الكل والناس تشوفه الأول؟<br>حول <b>20 جنيه</b> بس على فودافون كاش وبعدها إعلانك هيبقى مميز بعلامة ⭐</div><div style=background:#f1f8e9;padding:20px;border-radius:15px;margin:15px 0><p>رقم فودافون كاش</p><h1 style=color:#0d5a3c;letter-spacing:3px;margin:5px 0>{ADMIN_PHONE}</h1><p style=font-size:13px>باسم: {ADMIN_NAME}</p></div><a class=btn style=background:#25D366 href='https://wa.me/20{ADMIN_PHONE[1:]}?text=حولت ال20 جنيه تثبيت اعلان - وهذا سكرين التحويل' target=_blank>📸 ابعت سكرين التحويل واتساب</a><a href=/ class=btn style=background:#eee;color:#333>رجوع للرئيسية</a></div>""")

@app.route('/.well-known/assetlinks.json')
def assetlinks():
    return jsonify([{"relation": ["delegate_permission/common.handle_all_urls"],"target": {"namespace": "android_app","package_name": "com.laqetaha.app","sha256_cert_fingerprints": ["F3:8D:1D:3A:55:88:82:DF:70:60:03:10:5D:B2:B8:C3:C9:CC:20:01:66:82:50:21:6B:6F:4E:85:8A:26:C3:00"]}}])
